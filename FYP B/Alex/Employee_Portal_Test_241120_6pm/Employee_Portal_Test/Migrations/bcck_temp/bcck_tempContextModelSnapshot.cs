...
{
    [DbContext(typeof(bcck_tempContext))]
    partial class bcck_tempContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Employee_Portal_Test.Models.FamilyTemp", b =>
                {
                    ...
                    b.Property<string>("FATHERNM")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("MOTHERNM")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("family_temp");
                });

            modelBuilder.Entity("Employee_Portal_Test.Models.FamilyTempTemp", b =>
                {
                    b.Property<string>("Empno")
                        .HasColumnName("EMPNO")
                        .HasColumnType("char(6)")
                    ...
                    b.ToTable("family_temp_temp");
                });

            modelBuilder.Entity("Employee_Portal_Test.Models.History", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.Property<int>("Hodappr")
                        .HasColumnType("int");

                    b.Property<int>("Hrappr")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("Pecontact")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Pemerphone")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Pemerrship")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Phone")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Pitaxno")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("Prelcode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Psname")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Psnric")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Pstate")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Ptown")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Employee_Portal_Test.Models.PmastTemp", b =>
                {
                    b.Property<string>("Empno")
                        .HasColumnName("EMPNO")
                        .HasColumnType("char(6)")
                    ...
                    b.ToTable("pmast_temp");
                });

            modelBuilder.Entity("Employee_Portal_Test.Models.PmastTempTemp", b =>
                {
                    b.Property<string>("Empno")
                        .HasColumnName("EMPNO")
                        .HasColumnType("char(6)")
                    ...
                    b.ToTable("pmast_temp_temp");
                });

            modelBuilder.Entity("Employee_Portal_Test.Models.doc", b =>
                {
            ...
            modelBuilder.Entity("Employee_Portal_Test.Models.FamilyTemp", b =>
                {
                    b.HasOne("Employee_Portal_Test.Models.PmastTemp", "EmpnoNavigation")
                        .WithMany("FamilyTemp")
                        .HasForeignKey("Empno")
