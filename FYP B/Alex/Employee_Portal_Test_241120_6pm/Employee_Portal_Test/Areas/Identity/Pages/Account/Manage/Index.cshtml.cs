...
namespace Employee_Portal_Test.Areas.Identity.Pages.Account.Manage
{
    public partial class IndexModel : PageModel
    {
        ...
        private async Task LoadAsync(Employee_Portal_TestUser user)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (Input.PhoneNumber != phoneNumber)
            {
                ...
                Employee_Portal_TestUser user1 = _userManager.FindByIdAsync(data).Result;
                var qwe = db.Pmast.Where(x => x.Empno == user1.Empno).FirstOrDefault();
                qwe.Phone = Input.PhoneNumber;
                db.SaveChanges();
