...
namespace DataTransfer
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            string oledbpath = "Provider=VFPOLEDB.1;Data Source=C:\\Users\\sevqu\\Desktop\\ubs";
            string sqlpath = "Data Source=DESKTOP-6EIM981;;Initial Catalog=bcck;Integrated Security=True";
            OleDbConnection con = new OleDbConnection(oledbpath);
            SqlConnection con2 = new SqlConnection(sqlpath);


            OleDbCommand cmd = new OleDbCommand("select empno,add1,phone,mstatus,sname,snric,econtact,itaxno,relcode,emerphone,emerrship from pmast", con);
            SqlCommand cmd2 = new SqlCommand("select EMPNO,ADD1,PHONE,MSTATUS,SNAME,SNRIC,ECONTACT,ITAXNO,RELCODE,EMERPHONE,EMERRSHIP from pmast", con2);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            using (var sqlConn = new SqlConnection(sqlpath))
            {
                ...
                using (SqlCommand sqlCmd = new SqlCommand("select ADD1,PHONE,MSTATUS,SNAME,SNRIC,ECONTACT,ITAXNO,RELCODE,EMERPHONE,EMERRSHIP,EMPNO from pmast", sqlConn))
                {
                    sqlConn.Open();
            ...
            {
                using (OleDbCommand vfpCmd = new OleDbCommand("update pmast set add1 = ?, phone = ?, mstatus = ?, sname = ?, snric = ?, econtact = ?, itaxno = ?, relcode = ?, emerphone = ?, emerrship = ? where empno=?", vfpConn))
                {
                    ...
                    foreach (DataRow dr in dataFromSQL.Rows)
                    {
                        ...
                        if (!dr["add1"].Equals(null))
                        {
                            vfpCmd.Parameters[0].Value = null;
                        }
                        else
                        {
                            vfpCmd.Parameters[0].Value = dr["add1"];
                        }
                        if (!dr["phone"].Equals(null))
                        {
                            vfpCmd.Parameters[1].Value = null;
                        }
                        else
                        {
                            vfpCmd.Parameters[1].Value = dr["phone"];
                        }
                        if (!dr["mstatus"].Equals(null))
                        {
                            vfpCmd.Parameters[2].Value = null;
                        }
                        else
                        {
                        ...
                        if (dr["mstatus"].Equals("m") || dr["mstatus"].Equals("M"))
                        {
                            vfpCmd.Parameters[3].Value = dr["sname"];
                        }
                        else
                        {
                            vfpCmd.Parameters[3].Value = null;
                        }
                        if (dr["mstatus"].Equals("m") || dr["mstatus"].Equals("M"))
                        { 
                        ...
                        {
                            vfpCmd.Parameters[4].Value = null;
                        }
                        if(!dr["econtact"].Equals(null))
                        {
                            vfpCmd.Parameters[5].Value = null;
                        }
                        else
                        {
                            vfpCmd.Parameters[5].Value = dr["econtact"];
                        }
                        if (!dr["itaxno"].Equals(null))
                        {
                            vfpCmd.Parameters[6].Value = null;
                        }
                        else
                        {
                            vfpCmd.Parameters[6].Value = dr["itaxno"];
                        }
                        if (!dr["relcode"].Equals(null))
                        {
                            vfpCmd.Parameters[7].Value = null;
                        }
                        else
                        {
                            vfpCmd.Parameters[7].Value = dr["relcode"];
                        }
                        if (!dr["relcode"].Equals(null))
                        {
                            vfpCmd.Parameters[8].Value = null;
                        }
                        else
                        {
                            vfpCmd.Parameters[8].Value = dr["emerphone"];
                        }
                        if (!dr["emerrship"].Equals(null))
                            {
                            vfpCmd.Parameters[9].Value = null;
                        }
                        else
                        {
                            vfpCmd.Parameters[9].Value = dr["emerrship"];
                        }
                        if (!dr["emerrship"].Equals(null))
                            {
                            vfpCmd.Parameters[10].Value = null;
                        }
                        else
                        {
                            vfpCmd.Parameters[10].Value = dr["empno"];
                        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string oledbpath = "Provider=VFPOLEDB.1;Data Source=C:\\Users\\sevqu\\Desktop\\ubs";
            string sqlpath = "Data Source=DESKTOP-6EIM981;;Initial Catalog=bcck;Integrated Security=True";
            string sqlpathtemp = "Data Source=DESKTOP-6EIM981;;Initial Catalog=bcck_temp;Integrated Security=True";
            using (OleDbConnection sourcecon = new OleDbConnection(oledbpath))
            {
                //string sqlcom = "select family.empno, family.memname, family.nricno, family.sex, family.datebirth, pmastsub.fathernm, pmastsub.mothernm, pmastsub.resumdir from pmastsub inner join family on pmastsub.empno = family.empno";
