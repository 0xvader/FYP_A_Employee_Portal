...
namespace Employee_Portal_Test.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "Admin")]
        public async Task<IActionResult> Edit([Bind("id,Empno,Empno,EmpCode,Name,Iname,Add1,Add2,Dbirth,Nric,Passport,Phone,Phone2,Mstatus,National,Race,Relcode,Itaxno,Epfno,Bankcode,Bankaccno,Deptcode,Sname,Snric,Emerphone,Emerrship,Econtact")] Pmast pmast)
        {
