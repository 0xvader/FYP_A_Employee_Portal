...
{
    public partial class bcck_tempContext : DbContext
    {
        public bcck_tempContext()
        {
        }

        public bcck_tempContext(DbContextOptions<bcck_tempContext> options)
            : base(options)
        {
        }

        public virtual DbSet<FamilyTemp> FamilyTemp { get; set; }
        public virtual DbSet<FamilyTempTemp> FamilyTempTemp { get; set; }
        public virtual DbSet<History> History { get; set; }
        public virtual DbSet<PmastTemp> PmastTemp { get; set; }
        public virtual DbSet<PmastTempTemp> PmastTempTemp { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=LAPTOP-EP7E98DJ\\SQLEXPRESS;Initial Catalog=bcck_temp;Integrated Security=True");
            }
        ...
        {
            modelBuilder.Entity<FamilyTemp>(entity =>
            {
                entity.HasKey(e => new { e.Empno, e.Memname })
                    .HasName("PK_family_1");

                entity.ToTable("family_temp");
                ...
                entity.HasOne(d => d.EmpnoNavigation)
                    .WithMany(p => p.FamilyTemp)
                    .HasForeignKey(d => d.Empno)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_family_pmast");
            });

            modelBuilder.Entity<FamilyTempTemp>(entity =>
            {
                entity.HasKey(e => new { e.Empno, e.Memname });

                entity.ToTable("family_temp_temp");
            ...
            modelBuilder.Entity<PmastTemp>(entity =>
            {
                entity.HasKey(e => e.Empno)
                    .HasName("PK_pmast");

                entity.ToTable("pmast_temp");
            ...
            modelBuilder.Entity<PmastTempTemp>(entity =>
            {
                entity.HasKey(e => e.Empno);

                entity.ToTable("pmast_temp_temp");
